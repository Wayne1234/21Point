...
$(document).ready(function () {
    ...
    function hud() {
        ...
        $('#Shoe').click(function (e) {
            ...
            $(this).stop().animate({scale: os + 0.15}, 250);
        }, function () {
            $(this).stop().animate({scale: ns + 0.15}, 125);
        })
        ...
        $('a.Chip').animate({scale: ns}, 0).click(function (e) {
            if (GAME.clearing == false && !GAME.playing && !GAME.dealing && !GAME.hitting) {
                if (!$(this).hasClass('Locked')) {
                    bet($('#Player'), $(this).attr('id'));//id对应的是每个筹码的价值
                    //console.log($(this).attr('id'));
                }
            }
            return false
        }).hover(function () {
            if (parseInt($(this).css('opacity')) >= 1) {//>=1意味着这个时候的筹码没有被隐去，因此鼠标放上去之后需要放大
                $(this).stop().animate({scale: os}, 250);
            }
        }, function () {
        ...
        $('a.Action').animate({scale: ns}, 0).click(function (e) {
            if (GAME.clearing == false && GAME.playing && !GAME.dealing && !GAME.hitting) {
                if (!$(this).hasClass('Locked')) {//hasClass中的字符串匹配必须是单个单词
                    action($('#Player'), $(this).attr('id'));//对应的是动作id
                    console.log($(this).attr('id'));
                }
            }
            return false
    ...
    function bet(entity, b) {//调用处的参数是player和id
        switch (b) {
            default:
    ...
    function deck() {
        ...
        //prepend是前插入
        $('#Shoe').prepend
        ('<div id="Deck" style="margin-top:' + (-n) + 'px; padding-top:' + (n) + 'px"><div class="Card"><div class="Flip"><div class="Front"><div></div></div></div>')
        var c = $('#Shoe .Card')
